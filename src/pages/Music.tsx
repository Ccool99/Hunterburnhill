...
const cowboys1 = 'https://i.postimg.cc/FKbdHfKb/cowboys.jpg';
const johnLionTroubadour = 'https://i.postimg.cc/qqvL7mGZ/john-lion-joseph-logo.png';
const ghostTown = 'https://i.postimg.cc/VL8WgMhZ/ghost-town.png';
const saitPerformance2 = 'https://i.postimg.cc/bNgGQVTK/sait-performance.png';

...
const undertakerImage = 'https://cdn.jsdelivr.net/gh/user/images@main/undertaker-zoomed.png';
const saitPerformanceNewBackground = 'https://cdn.jsdelivr.net/gh/user/images@main/stage-performance.png';
const starLightHeader = 'https://cdn.jsdelivr.net/gh/user/images@main/star-light-header.png';
const epkMinerPhoto = 'https://cdn.jsdelivr.net/gh/user/images@main/the-miner.png';
const starLightHeaderImg = 'https://cdn.jsdelivr.net/gh/user/images@main/star-light-header.png';
const undertakerZoomed = 'https://cdn.jsdelivr.net/gh/user/images@main/undertaker-zoomed.png';

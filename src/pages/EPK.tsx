...
import epkMinerPhoto from '@assets/the-miner-fixed.png';
import starLightHeaderImg from '@assets/star-light-header.png';
import undertakerZoomed from '@assets/undertaker-zoomed.png';

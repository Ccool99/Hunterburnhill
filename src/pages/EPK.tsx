...
const saitPerformanceNewBackground = 'https://i.postimg.cc/bNgGQVTK/sait-performance.png';
const starLightHeader = 'https://i.postimg.cc/7L5kWc2y/star-light-header.png';
const epkMinerPhoto = 'https://i.postimg.cc/8CMWfVXn/the-miner.png';
const starLightHeaderImg = 'https://i.postimg.cc/7L5kWc2y/star-light-header.png';
const undertakerZoomed = 'https://i.postimg.cc/J0mGcWDf/undertaker-zoomed.png';

...
// Real image URLs - hosted on Netlify
...
const cowboysImage = '/images/cowboys.jpg';
const performanceImage = '/images/performance.jpg';
import theMinerPhoto from '@assets/the-miner-fixed.png';

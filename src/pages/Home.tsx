...
const saitPerformanceEdited = 'https://cdn.jsdelivr.net/gh/user/images@main/stage-performance.png';
const johnLionTroubadour = 'https://cdn.jsdelivr.net/gh/user/images@main/john-lion-logo.png';
const cowboysImage = 'https://cdn.jsdelivr.net/gh/user/images@main/cowboys.jpg';
const performanceImage = 'https://cdn.jsdelivr.net/gh/user/images@main/stage-performance.png';
const theMinerPhoto = 'https://cdn.jsdelivr.net/gh/user/images@main/the-miner.png';

...
// Real image URLs using Picsum for reliable hosting
const erraticPhoto = 'https://picsum.photos/800/600?random=1';
const undertakerImage = 'https://picsum.photos/800/600?random=2';
const saitPerformanceEdited = 'https://picsum.photos/800/600?random=3';
const johnLionTroubadour = 'https://picsum.photos/200/200?random=4';
const cowboysImage = 'https://picsum.photos/800/600?random=5';
const performanceImage = 'https://picsum.photos/800/600?random=6';
const theMinerPhoto = 'https://picsum.photos/400/500?random=7';
